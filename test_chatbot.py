...
test_cases = [
    ...
    {"question": "what is the cheapest dish", "ground_truth": "Walnut Brownie at 142 rupees"}
]
...
for case in test_cases:
    ...
    for attempt in range(3):
        response = get_answer(case['question'], session_id="eval_user", restaurant_id="rest_delhi_01")
